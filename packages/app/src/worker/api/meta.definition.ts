					...
					'application/json': {
						schema: {
							...
							properties: {
								...
								indieAuthEnabled: { type: 'boolean', description: 'Whether IndieAuth (Misskey) sign-in is enabled' },
							},
							required: ['registrationEnabled', 'passphraseRequired', 'turnstileEnabled', 'turnstileSiteKey', 'googleAuthEnabled', 'googleRequired', 'indieAuthEnabled'],
